...
namespace OrleansBlazor.Silo.Services
{
    public class TodoService
    {
        ...
        public TodoService(ILogger<TodoService> logger, IGrainFactory client, IServiceProvider serviceProvider)
        {
            this.logger = logger;
            this.client = client;
            streamProvider = serviceProvider.GetServiceByName<IStreamProvider>("SMS");
        }
